...
for i = firstnum:frames_img
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [simimg subimg simsubimg] = getSimilarImg_BGSp(convimg,model,img);          %
                                                                                %
    thrimg = thresholdImage(simimg,g_fgthreshold*255);                          %
    finimg = thresholdImage(simimg,0.4*255);                                    %
    ...
    elseif framecnt == g_framethreshold
        model = updateModel_BGSp(convimg,thrimg,model,subimg,bestbkimg);
        i
        framecnt = 1;
        disp('update the bk model');
    ...
    displayMatrixImage(i,2,3,convimg,bkimg,bestbkimg,simimg,thrimg,finimg);
